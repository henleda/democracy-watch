        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm">
              Making congressional accountability transparent and accessible to every citizen.
            </p>
          </div>
          ...
          {/* Data Sources */}
          <div>
            <h4 className="font-semibold text-white mb-4 text-sm uppercase tracking-wider">Data Sources</h4>
